...
def load_model_and_encoder():
    ...
    model_path = r"C:\Users\KIIT\OneDrive\Desktop\Traffic Project\TrafficModel\traffic_model.pkl"
    with open(model_path, 'rb') as file:
        model = pickle.load(file)
    
    # Load the label encoder from the specific path
    encoder_path = r"C:\Users\KIIT\OneDrive\Desktop\Traffic Project\TrafficModel\label_encoder.pkl"
